...
from tools.mess import messMenu
...
mcp.mount("Mess", messMenu.mcp)
mcp.mount("DateTime", datetime.mcp)
...
def infoOfperson(name: str):
    """Give contact details of people working at IIT Mandi, Professor's and staff, it takes only the name of person as augument."""
...
if __name__ == "__main__":
    ...
    asyncio.run(mcp.run_http_async(host="localhost", port=1729), debug=True)